...
On lance le fichier avec ligne de commande "$ python3 compilo.py tests/exemple1.arith"
...
On lance le fichier avec ligne de commande "$ python3 compilo.py tests/exemple2.bool"
